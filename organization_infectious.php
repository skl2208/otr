...
?>    
    <section class="rootnavigator mx-lg-5 mx-md-1 mx-0 p-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col"><a href="index.php">หน้าแรก</a>/สาขาวิชาอายุรศาสตร์โรคติดเชื้อ</div>
            </div>
        </div>
    </section>
    <section class="listOrganization">
        <div class="container-fluid">
            ...
            $sql = "SELECT nameth,nameen,description from department where nameth='อายุรศาสตร์โรคติดเชื้อ'";
            ...
            $sql = "select seq,titlename,name,surname,picture_URL,graduation,download_URL from officer where controlunit='อายุรศาสตร์โรคติดเชื้อ' and position='อาจารย์แพทย์' and status='Y' order by seq,name,surname";
            ...
            $sql = "select titlename,name,surname,picture_URL,graduation,download_URL from officer where controlunit='อายุรศาสตร์โรคติดเชื้อ' and position='อาจารย์พิเศษ' and status='Y' order by seq,name,surname";
            $result1 = $conn->query($sql);
            if ($result1->num_rows > 0) {
