...
<section class="rootnavigator mx-lg-5 mx-md-1 mx-0 p-3">
    <div class="container-fluid">
        <div class="row">
            <div class="col"><a href="index.php">หน้าแรก</a>/สาขาวิชาโภชนศาสตร์คลินิก</div>
        </div>
    </div>
</section>
<section class="listOrganization">
    <div class="container-fluid">
        <div class="row mx-lg-5 mx-md-1 mx-sm-0">
            ...
            $sql = "SELECT nameth,nameen,description from department where nameth='โภชนศาสตร์คลินิก'";
            ...
            $sql = "select seq,titlename,name,surname,picture_URL,graduation,download_URL from officer where controlunit='โภชนศาสตร์คลินิก' and position='อาจารย์แพทย์' and status='Y' order by seq,name,surname";
            ...
            $sql = "select titlename,name,surname,picture_URL,graduation,download_URL from officer where controlunit='โภชนศาสตร์คลินิก' and position='อาจารย์พิเศษ' and status='Y' order by seq,name,surname";
            $result1 = $conn->query($sql);
            if ($result1->num_rows > 0) {
