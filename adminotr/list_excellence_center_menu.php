...
<script>
    $(function() {
        manage_excellence_menu.list(1);
    });
</script>
<h3>จัดการเมนู Excellence</h3>
<div><button class="btn1" onclick="javascript:manage_excellence_menu.add(5);">เพิ่มเมนู</button></div>
<div class="mt-3" id="displayTotalRec"></div>
<div class="d-table w-100 mt-1 list-excellence-center-menu">
    <div class="d-table w-100 mt-1">
        <div style="display:table-row">
            ...
            <div class="ps-2 smallerFont head-row"> </div>
        </div>
        <div class="mt-3 biggerFont">ไม่มีข้อมูล</div>
    </div>
</div>
