...
<script>
    function doCancel() {
        window.location.href = manage_department_menu.callbackURL;
    }
    ...
    function validate_data() {
        ...
        manage_department_menu.save(document.forms.formedit);
...
<h3><?php echo $headline ?> เมนู สาขาวิชา</h3>
<section id="main">
    <form method="POST" name="formedit" id="formedit">
        ...
        <div class="d-table w-100 mt-3">
            <div class="ps-2 text-center d-table-cell">
                ...
                <button type="button" class="btnCancel" onclick="javascript:manage_department_menu.cancel();"><img src="../images/ic_close.png"> ยกเลิก</button>
            </div>
        </div>
