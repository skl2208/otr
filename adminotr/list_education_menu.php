...
<script>
    $(function() {
        manage_education_menu.list(1);
    });
</script>
<h3>จัดการเมนู การศึกษา</h3>
<div><button class="btn1" onclick="javascript:manage_education_menu.add(3);">เพิ่มเมนู</button></div>
<div class="mt-3" id="displayTotalRec"></div>
<div class="d-table w-100 mt-1 list-education-menu">
