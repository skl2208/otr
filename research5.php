    ...
    <div class="container-fluid">
        <div class="row mx-lg-5 mx-md-1 mx-sm-0 template-2 pb-3 shadow-sm">
            <div class="col-12 mt-lg-3 mt-md-2">
                <h2 class="topic-header">งานวิจัยผลงานตีพิมพ์ที่มีส่วนร่วมในระดับนานาชาติ</h2>
            </div>
            <?php
            $sql = "SELECT count(id) as Totalrec FROM research WHERE status='Y' AND group_name='งานวิจัยผลงานตีพิมพ์ที่มีส่วนร่วมในระดับนานาชาติ'";
            ...
            if($result0 && $result0->num_rows > 0) {
                ...
                $sql = "SELECT * FROM research WHERE status='Y' AND group_name='งานวิจัยผลงานตีพิมพ์ที่มีส่วนร่วมในระดับนานาชาติ' ORDER BY create_date DESC,topic ";
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<span class=\"topic-header\">".$row["name"]."</span></div>";
